...
public class OrderResponseDto {
    ...
    public List<ProductOrderResponseDto> getItems() {
        return items;
    }

    public void setItems(List<ProductOrderResponseDto> items) {
        this.items = items;
    }
